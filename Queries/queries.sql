...
-- first requested list is general employee information
SELECT e.emp_no,
    e.first_name,
    e.last_name,
    e.gender,
...
-- contain everything in the retirement_info table, only tailored for the Sales team
SELECT * FROM retirement_info;
SELECT ri.emp_no,
       ri.first_name,
	   ri.last_name,
...
-- contain everything in the retirement_info table, only tailored for the Sales team and development team
SELECT * FROM retirement_info;
SELECT ri.emp_no,
       ri.first_name,
	   ri.last_name,
